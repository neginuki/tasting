 ...
 */
package world.sake.mylasta.action;

import world.sake.mylasta.action.AssertjdbeLabels;
 ...
 * @author FreeGen
 */
public class AssertjdbeMessages extends AssertjdbeLabels {
     ...
     */
    @Override
    public AssertjdbeMessages addConstraintsAssertFalseMessage(String property) {
     ...
     */
    @Override
    public AssertjdbeMessages addConstraintsAssertTrueMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public AssertjdbeMessages addConstraintsDecimalMaxMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public AssertjdbeMessages addConstraintsDecimalMinMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public AssertjdbeMessages addConstraintsDigitsMessage(String property, String fraction, String integer) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public AssertjdbeMessages addConstraintsEmailMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public AssertjdbeMessages addConstraintsFutureMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public AssertjdbeMessages addConstraintsMaxMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public AssertjdbeMessages addConstraintsMinMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public AssertjdbeMessages addConstraintsNotBlankMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public AssertjdbeMessages addConstraintsNotEmptyMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public AssertjdbeMessages addConstraintsNotNullMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public AssertjdbeMessages addConstraintsNullMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public AssertjdbeMessages addConstraintsPastMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public AssertjdbeMessages addConstraintsPatternMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public AssertjdbeMessages addConstraintsSizeMessage(String property, String min, String max) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public AssertjdbeMessages addConstraintsCreditCardNumberMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public AssertjdbeMessages addConstraintsEanMessage(String property, String type) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public AssertjdbeMessages addConstraintsLengthMessage(String property, String min, String max) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public AssertjdbeMessages addConstraintsLuhnCheckMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public AssertjdbeMessages addConstraintsMod10CheckMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public AssertjdbeMessages addConstraintsMod11CheckMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public AssertjdbeMessages addConstraintsModCheckMessage(String property, String modType, String value) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public AssertjdbeMessages addConstraintsParametersScriptAssertMessage(String property, String script) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public AssertjdbeMessages addConstraintsRangeMessage(String property, String min, String max) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public AssertjdbeMessages addConstraintsSafeHtmlMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public AssertjdbeMessages addConstraintsScriptAssertMessage(String property, String script) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public AssertjdbeMessages addConstraintsUrlMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public AssertjdbeMessages addConstraintsRequiredMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public AssertjdbeMessages addConstraintsTypeAnyMessage(String property, String propertyType) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public AssertjdbeMessages addConstraintsTypeIntegerMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public AssertjdbeMessages addConstraintsTypeLongMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public AssertjdbeMessages addConstraintsTypeLocalDateMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public AssertjdbeMessages addConstraintsTypeLocalDateTimeMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public AssertjdbeMessages addConstraintsTypeBooleanMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public AssertjdbeMessages addErrorsLoginFailure(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public AssertjdbeMessages addErrorsAppIllegalTransition(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public AssertjdbeMessages addErrorsAppDbAlreadyDeleted(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public AssertjdbeMessages addErrorsAppDbAlreadyUpdated(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public AssertjdbeMessages addErrorsAppDbAlreadyExists(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public AssertjdbeMessages addErrorsAppDoubleSubmitRequest(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public AssertjdbeMessages addErrorsLoginRequired(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public AssertjdbeMessages addErrorsUnknownBusinessError(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public AssertjdbeMessages addErrorsSignupAccountAlreadyExists(String property) {
        assertPropertyNotNull(property);
