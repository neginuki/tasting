 ...
 * @author FreeGen
 */
public interface AssertjdbeEnv extends TastingConfig {

    /** The key of the configuration. e.g. assertjdbe-support@saw.example.com */
     ...
     * The value is, e.g. assertjdbe-support@saw.example.com <br>
     * comment: Mail Address for Assertjdbe Support
     ...
     * @author FreeGen
     */
    public static class SimpleImpl extends TastingConfig.SimpleImpl implements AssertjdbeEnv {

        /** The serial version UID for object serialization. (Default) */
        private static final long serialVersionUID = 1L;

        public String getMailAddressSupport() {
            return get(AssertjdbeEnv.MAIL_ADDRESS_SUPPORT);
        }

        public String getServerDomain() {
            return get(AssertjdbeEnv.SERVER_DOMAIN);
        }
    }
}
