 ...
 */
package world.sake.unit.mock;

import java.util.List;

import org.dbflute.jdbc.ClassificationMeta;
import org.dbflute.optional.OptionalThing;
import world.sake.mylasta.direction.TastingFwAssistantDirector;
import world.sake.mylasta.direction.sponsor.TastingApiFailureHook;
import world.sake.mylasta.direction.sponsor.TastingListedClassificationProvider;
 ...
 * @author jflute
 */
public class MockTastingFwAssistantDirector extends TastingFwAssistantDirector {
    ...
    protected ListedClassificationProvider createListedClassificationProvider() {
        return new TastingListedClassificationProvider() {
    ...
    protected ApiFailureHook createApiFailureHook() {
        return new TastingApiFailureHook() {
