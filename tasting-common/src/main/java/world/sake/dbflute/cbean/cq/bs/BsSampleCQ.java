...
public class BsSampleCQ extends AbstractBsSampleCQ {
    ...
    public ConditionValue xdfgetSampleId()
    { if (_sampleId == null) { _sampleId = nCV(); }
      return _sampleId; }
    protected ConditionValue xgetCValueSampleId() { return xdfgetSampleId(); }
     ...
     * @return this. (NotNull)
     */
    public BsSampleCQ addOrderBy_SampleId_Asc() { regOBA("SAMPLE_ID"); return this; }
     ...
     * @return this. (NotNull)
     */
    public BsSampleCQ addOrderBy_SampleId_Desc() { regOBD("SAMPLE_ID"); return this; }
