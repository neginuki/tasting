...
import world.sake.app.logic.context.AccessContextLogic;
import world.sake.mylasta.action.TastingUserBean;
 ...
 * @author jflute
 */
public abstract class TastingBaseAction extends TypicalAction {
    ...
    //                                                                           =========
    @Override
    protected abstract OptionalThing<? extends TastingUserBean> getUserBean(); // to be more concrete
