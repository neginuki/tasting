 ...
 * @author jflute
 */
public class TastingCurtainBeforeHook implements CurtainBeforeHook {
    ...
    protected DfFinalTimeZoneProvider createFinalTimeZoneProvider() {
        return new DfFinalTimeZoneProvider() {
            protected final TimeZone provided = TastingUserTimeZoneProcessProvider.centralTimeZone;
