 ...
 * @author jflute
 */
public class TastingSecurityResourceProvider implements SecurityResourceProvider {
    ...
    public TastingSecurityResourceProvider(InvertibleCryptographer primaryInvertibleCryptographer,
