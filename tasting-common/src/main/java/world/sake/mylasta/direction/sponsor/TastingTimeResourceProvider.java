 ...
 * @author jflute
 */
public class TastingTimeResourceProvider extends TypicalTimeResourceProvider {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public TastingTimeResourceProvider(TastingConfig config) {
        this.config = config;
    }
    ...
    protected TimeZone getCentralTimeZone() {
        return TastingUserTimeZoneProcessProvider.centralTimeZone;
    }
