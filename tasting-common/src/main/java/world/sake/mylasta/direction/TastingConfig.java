...
import world.sake.mylasta.direction.TastingEnv;
import org.lastaflute.core.direction.exception.ConfigPropertyNotFoundException;

/**
 * @author FreeGen
 */
public interface TastingConfig extends TastingEnv {

    /** The key of the configuration. e.g. tasting */
     ...
     * @author FreeGen
     */
    public static class SimpleImpl extends TastingEnv.SimpleImpl implements TastingConfig {

        /** The serial version UID for object serialization. (Default) */
        private static final long serialVersionUID = 1L;

        public String getDomainName() {
            return get(TastingConfig.DOMAIN_NAME);
        }

        public String getDomainTitle() {
            return get(TastingConfig.DOMAIN_TITLE);
        }

        public String getAppStandardDatePattern() {
            return get(TastingConfig.APP_STANDARD_DATE_PATTERN);
        }

        public String getAppStandardDatetimePattern() {
            return get(TastingConfig.APP_STANDARD_DATETIME_PATTERN);
        }

        public String getAppStandardTimePattern() {
            return get(TastingConfig.APP_STANDARD_TIME_PATTERN);
        }

        public String getCookieDefaultPath() {
            return get(TastingConfig.COOKIE_DEFAULT_PATH);
        }

        public String getCookieDefaultExpire() {
            return get(TastingConfig.COOKIE_DEFAULT_EXPIRE);
        }

        public Integer getCookieDefaultExpireAsInteger() {
            return getAsInteger(TastingConfig.COOKIE_DEFAULT_EXPIRE);
        }

        public String getCookieEternalExpire() {
            return get(TastingConfig.COOKIE_ETERNAL_EXPIRE);
        }

        public Integer getCookieEternalExpireAsInteger() {
            return getAsInteger(TastingConfig.COOKIE_ETERNAL_EXPIRE);
        }
    }
}
