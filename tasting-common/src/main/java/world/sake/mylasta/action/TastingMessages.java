...
import world.sake.mylasta.action.TastingLabels;
 ...
 * @author FreeGen
 */
public class TastingMessages extends TastingLabels {
     ...
     * @return this. (NotNull)
     */
    public TastingMessages addConstraintsAssertFalseMessage(String property) {
     ...
     * @return this. (NotNull)
     */
    public TastingMessages addConstraintsAssertTrueMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TastingMessages addConstraintsDecimalMaxMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TastingMessages addConstraintsDecimalMinMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TastingMessages addConstraintsDigitsMessage(String property, String fraction, String integer) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TastingMessages addConstraintsEmailMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TastingMessages addConstraintsFutureMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TastingMessages addConstraintsMaxMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TastingMessages addConstraintsMinMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TastingMessages addConstraintsNotBlankMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TastingMessages addConstraintsNotEmptyMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TastingMessages addConstraintsNotNullMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TastingMessages addConstraintsNullMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TastingMessages addConstraintsPastMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TastingMessages addConstraintsPatternMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TastingMessages addConstraintsSizeMessage(String property, String min, String max) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TastingMessages addConstraintsCreditCardNumberMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TastingMessages addConstraintsEanMessage(String property, String type) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TastingMessages addConstraintsLengthMessage(String property, String min, String max) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TastingMessages addConstraintsLuhnCheckMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TastingMessages addConstraintsMod10CheckMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TastingMessages addConstraintsMod11CheckMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TastingMessages addConstraintsModCheckMessage(String property, String modType, String value) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TastingMessages addConstraintsParametersScriptAssertMessage(String property, String script) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TastingMessages addConstraintsRangeMessage(String property, String min, String max) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TastingMessages addConstraintsSafeHtmlMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TastingMessages addConstraintsScriptAssertMessage(String property, String script) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TastingMessages addConstraintsUrlMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TastingMessages addConstraintsRequiredMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TastingMessages addConstraintsTypeAnyMessage(String property, String propertyType) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TastingMessages addConstraintsTypeIntegerMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TastingMessages addConstraintsTypeLongMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TastingMessages addConstraintsTypeLocalDateMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TastingMessages addConstraintsTypeLocalDateTimeMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TastingMessages addConstraintsTypeBooleanMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TastingMessages addErrorsLoginFailure(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TastingMessages addErrorsAppIllegalTransition(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TastingMessages addErrorsAppDbAlreadyDeleted(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TastingMessages addErrorsAppDbAlreadyUpdated(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TastingMessages addErrorsAppDbAlreadyExists(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public TastingMessages addErrorsAppDoubleSubmitRequest(String property) {
        assertPropertyNotNull(property);
